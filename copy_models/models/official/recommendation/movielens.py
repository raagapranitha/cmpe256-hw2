...
GENRES = ['dress', 'sheath', 'gown', 'top', 'jacket', 'bomber', 'sweater',
       'blazer', 'shirtdress', 'maxi', 'jumpsuit', 'leggings', 'coat',
       'duster', 'shirt', 'tank', 'skirt', 'pant', 'kimono', 'pants',
       'skirts', 'shift', 'tight', 'blouse', 'romper', 'down', 'poncho',
       'tunic', 'legging', 'knit', 'culottes', 'trousers', 'cape',
       'cardigan', 'peacoat', 'trouser', 'pullover', 'vest', 'culotte',
       'overalls', 'sweatshirt', 't-shirt', 'tee', 'henley', 'jogger',
       'parka', 'kaftan', 'midi', 'trench', 'mini', 'hoodie', 'combo',
       'turtleneck', 'blouson', 'print', 'caftan', 'suit'
]
N_GENRE = len(GENRES)

RATING_COLUMNS = [USER_COLUMN, ITEM_COLUMN, RATING_COLUMN, TIMESTAMP_COLUMN]
MOVIE_COLUMNS = [ITEM_COLUMN, GENRE_COLUMN]
...
DATASET_TO_NUM_USERS_AND_ITEMS = {ML_1M: (221, 3547)}
